...
//private double MaxAngularRate = 1.5 * Math.PI; // 3/4 of a rotation per second max angular velocity
  ...
  private void ConfigureTelemtry() {
    var tab = Shuffleboard.getTab("DriveSubsystem");
    MotorTelemetry.AddMotorTelemetry(tab, "Swerve 0", getModule(0));    
    MotorTelemetry.AddMotorTelemetry(tab, "Swerve 1", getModule(1));
    MotorTelemetry.AddMotorTelemetry(tab, "Swerve 2", getModule(2));
    MotorTelemetry.AddMotorTelemetry(tab, "Swerve 3", getModule(3));
